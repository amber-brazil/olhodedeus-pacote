...
export async function registerGodeye(options) {
    configureGodeye(options);
    console.log("[godeye] registerGodeye() source=", options.source, "runtime=", process.env.NEXT_RUNTIME);
    try {
        ...
        if (process.env.NEXT_RUNTIME === "nodejs") {
            ...
            instrumentations.push(new HttpInstrumentation({ requestHook: godeyeRequestHook }));
        }
        registerOTel({
