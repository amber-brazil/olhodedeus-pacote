...
const globalForGodeye = globalThis;
export const enrichByTrace = globalForGodeye.__godeyeEnrichByTrace ??
    (globalForGodeye.__godeyeEnrichByTrace = new Map());
...
export function setTraceEnrichment(traceId, patch) {
 ...
 */
export function setGodeyeUser(userId) {
